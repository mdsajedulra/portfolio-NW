...
const Skills = () => {
  ...
  const skills: Skill[] = [
    ...
    { name: "mongoose", level: 3, category: "database" },
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 flex items-center">
              <span className="bg-neonBlue/20 text-neonBlue w-10 h-10 flex items-center justify-center rounded-full mr-3">
                F
              </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {getSkillsByCategory("frontend").map((skill) => (
                <div
                  key={skill.name}
                  className="bg-card rounded-lg p-4 border border-border hover:border-neonBlue transition-colors"
                >
          ...
          <div className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 flex items-center">
              <span className="bg-skyBlue/20 text-skyBlue w-10 h-10 flex items-center justify-center rounded-full mr-3">
                B
              </span>
              Backend Development
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {getSkillsByCategory("backend").map((skill) => (
                <div
                  key={skill.name}
                  className="bg-card rounded-lg p-4 border border-border hover:border-skyBlue transition-colors"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-medium">{skill.name}</h3>
          ...
          <div className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 flex items-center">
              <span className="bg-aquaGreen/20 text-aquaGreen w-10 h-10 flex items-center justify-center rounded-full mr-3">
                D
              </span>
              Database & Storage
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {getSkillsByCategory("database").map((skill) => (
                <div
                  key={skill.name}
                  className="bg-card rounded-lg p-4 border border-border hover:border-aquaGreen transition-colors"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-medium">{skill.name}</h3>
          ...
          <div className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 flex items-center">
              <span className="bg-purpleTint/20 text-purpleTint w-10 h-10 flex items-center justify-center rounded-full mr-3">
                D
              </span>
              DevOps & Deployment
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {getSkillsByCategory("devops").map((skill) => (
                <div
                  key={skill.name}
                  className="bg-card rounded-lg p-4 border border-border hover:border-purpleTint transition-colors"
                >
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-medium">{skill.name}</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            {getSkillsByCategory("soft").map((skill) => (
              <div
                key={skill.name}
                className="bg-card rounded-lg p-6 border border-border hover:border-neonBlue transition-colors shadow-sm"
              >
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="bg-card rounded-lg p-6 border border-border hover:border-neonBlue transition-colors shadow-sm">
              ...
              <p className="text-muted-foreground text-sm">
                Containerizing applications and managing development
            ...
            <div className="bg-card rounded-lg p-6 border border-border hover:border-neonBlue transition-colors shadow-sm">
              ...
              <p className="text-muted-foreground text-sm">
                Using Prisma ORM for database schema management and type-safe
                queries.
              </p>
            </div>
            ...
            <div className="bg-card rounded-lg p-6 border border-border hover:border-neonBlue transition-colors shadow-sm">
              ...
              <p className="text-muted-foreground text-sm">
                Working with relational databases using PostgreSQL for scalable
                data storage.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              If my skill set aligns with your project requirements, let's
