      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-gradient">Sajedul I.</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://github.com/mdsajedulra" 
                target="_blank" 
              ...
              <a 
                href="mailto:mdsajedulra@gmail.com" 
                className="p-2 bg-muted-foreground/10 rounded-full hover:bg-neonBlue/20 transition-colors"
              >
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <p>© {currentYear} Sajedul l. All rights reserved.</p>
